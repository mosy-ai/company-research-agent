...
""",
        ...
        # Sort documents by evaluation score (highest first) - using the original approach
        sorted_items = sorted(
            items, 
...
"""
    ...
    async def create_briefings(self, state: ResearchState) -> Dict[str, Any]:
        ...
        categories = {
            ...
            'partners_data': ("partners", "partners_briefing")  # Added partners category
        }
        ...
        for data_field, (cat, briefing_key) in categories.items():
            ...
            # Make sure curated_data is a dict, not a string or None

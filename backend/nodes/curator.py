...
class Curator:
    ...
    async def curate_data(self, state: ResearchState) -> ResearchState:
                ...
                await websocket_manager.send_status_update(
                    ...
                    result={
                        ...
                        "doc_counts": {
                            ...
                            "partners": {"initial": 0, "kept": 0}  # Added partners
                        }
                    }
                )
        ...
        data_types = {
            ...
            'partners_data': ('🤝 Partners', 'partners')  # Added partners
        }
                ...
                await websocket_manager.send_status_update(
                    ...
                    result={
                        ...
                        "doc_counts": {
                            ...
                            "partners": doc_counts.get('partners_data', {"initial": 0, "kept": 0})  # Added partners
                        }
                    }
                )
